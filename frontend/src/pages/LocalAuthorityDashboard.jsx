                    ...
                    <div className="w-full h-32 mb-3 rounded-xl overflow-hidden bg-black/5 relative">
                      <img 
                        ...
                        onError={(e) => { 
                          ...
                          fallback.className = 'w-full h-full bg-black/5 flex items-center justify-center text-textMuted flex-col gap-1';
                          fallback.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg><span class="text-[8px] font-bold uppercase">Load Failed</span>';
                    ...
                    <div className="rounded-xl overflow-hidden mb-2 border border-black/5">
                      <img 
                        ...
                        onError={(e) => { 
                          e.currentTarget.style.display = 'none'; 
                          const fallback = document.createElement('div');
                          fallback.className = 'w-full h-32 bg-black/5 flex items-center justify-center text-textMuted flex-col gap-1';
                          fallback.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg><span class="text-[8px] font-bold uppercase">Load Failed</span>';
                          e.currentTarget.parentElement.appendChild(fallback);
                        }}
                      />
